...
// in each row we are calculating the forward value with the previous value using this formula
// we dont need to call any functions while using this formula
